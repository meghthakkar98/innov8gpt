...
def test_email_settings():
    ...
    if not all([smtp_server, smtp_port, smtp_username, smtp_password, smtp_from_email, test_recipient]):
        return jsonify({'success': False, 'error': 'All email settings are required'}), 400
    
    try:
        # Create message
        msg = MIMEMultipart('alternative')
        msg['Subject'] = 'Test Email from Simple Chat'
        msg['From'] = smtp_from_email
        msg['To'] = test_recipient
        
        # Add text content
        text_content = 'This is a test email from Simple Chat. If you can read this, email settings are working correctly.'
